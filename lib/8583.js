...
class Main {
    ...
    unpack_127_25_1_63(slice_127_25,isoJSON){
        console.log(slice_127_25.byteLength)
        if(slice_127_25.byteLength<10){
            return {json:isoJSON, remSlice:slice_127_25}
        }
        else {
            console.log(slice_127_25.toString())
            console.log(slice_127_25.slice(2, 10).toString('hex'))
    ...
    unpack_127_1_63(slice_127,isoJSON){
        ...
        console.log(slice_127.slice(2, 10).toString('hex'))
    ...
    unpack_127(incoming,isoJSON) {
        if(Buffer.isBuffer(incoming)){
            ...
            console.log(incoming.slice(4, 20).toString('hex'))
