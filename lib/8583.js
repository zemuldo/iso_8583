...
class Main {
   ...
   * @example new Main(validMessage,customFormats, []).validateMessage() -> true
   * @example new Main(invalidMessage,customFormats, []).validateMessage() -> false
   */
  validateMessage() {
    let valid = false;
   ...
   * @returns {object} Object with property error
   * @example new Main(validMessage,customFormats, []).getBufferMessage() -> <Buffer 01 11 30 31 30 30 f2 ...
   * @example new Main(invalidMessage,customFormats, []).getBufferMessage() -> {error: 'some error message'}
   */
  getBufferMessage() {
